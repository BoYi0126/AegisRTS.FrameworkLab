...
| OI-P0-03 | P035 arm-length change request已由P035R1實作；後續shield alignment change request已由P035R2實作，Shield Top／Center／Bottom為0.7016H／0.4643H／0.2271H，尺寸仍為0.600×0.862 m，grip／strap close-up與隔離Unity evidence存在，但18項Revision 02 Gate仍全數待Reviewer。 | 比例／attachment候選尚未human sign-off；`READY FOR PHASE03_5 REVISION02 REVIEW`不得解讀為PRE-UV GEOMETRY LOCK、Phase 04 authorization或Production Ready。 | User + art + technical art：審查`Infantry_Phase03_5_Revision02_Shield_Alignment_Review/05_Review_Checklist.md`，特別判斷shield vertical relationship、grip／strap、wrist／elbow、clipping與Unity Close／RTS Normal。 |
...
- a fully approved Infantry production reference（v004_P035R2與Unity evidence存在，但Phase 03.5 Revision 02 human review／PRE-UV geometry lock仍pending）;
