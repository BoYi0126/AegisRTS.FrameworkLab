...
| OI-P0-02 | Requested direction is “Stylized Fantasy RTS”, while legacy specs describe a world-neutral, East-Asian-ancient-inspired low-poly prototype. No approved Art Bible resolves how much of either direction is binding. | A remaster could hard-code an unintended world/faction or discard useful prototype readability. | Design/art director: approve a versioned, world-neutral visual framework and faction-specific extension rules before new L1 approval. |
| OI-P0-03 | Infantry has a polished legacy concept sheet but no formal L2 production character sheet under the new L1/L2 semantics. The old `L2` label refers to a playable game model. | Construction, topology, deformation, materials and LOD intent are not locked before production remaster. | Art + technical art: review/revise L1, author formal L2 and approve both. |
...
- an Infantry L2 production character sheet;
