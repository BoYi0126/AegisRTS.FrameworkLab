...
|---|---|---|---|---|---|
| P0.1 | Infantry | `unit.infantry` | PROTOTYPE / partial-remaster candidate | Provenance; production L1/L2; durable source actions; production texture/team-mask shader; production LOD and deformation; Unity evidence | Resolve rights and art-direction conflict, approve L1 then L2; perform scoped remaster only after those gates |
